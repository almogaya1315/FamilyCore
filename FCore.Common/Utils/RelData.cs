...
namespace FCore.Common.Utils
{
    internal static class RelData
    {
        ...
        {
            if (relGender == GenderType.Male) return RelationshipType.Great_GrangFather.ToString();
        ...
        {
            if (relativeRelativeRel.Relationship == RelationshipType.Aunt.ToString()) return RelationshipType.Aunt.ToString();
            ...
            if (relativeRelativeRel.Relationship == RelationshipType.Cousin.ToString()) return RelationshipType.Cousin.ToString();
            ...
            if (relativeRelativeRel.Relationship == RelationshipType.Grandfather.ToString()) return RelationshipType.Grandfather.ToString();
            if (relativeRelativeRel.Relationship == RelationshipType.Grandmother.ToString()) return RelationshipType.Grandmother.ToString();
            ...
            if (relativeRelativeRel.Relationship == RelationshipType.Uncle.ToString()) return RelationshipType.Uncle.ToString();
        ...
        {
            if (relativeRelativeRel.Relationship == RelationshipType.Aunt.ToString()) return RelationshipType.Undefined.ToString(); // modified
            if (relativeRelativeRel.Relationship == RelationshipType.Brother.ToString()) return RelationshipType.Uncle.ToString();
            if (relativeRelativeRel.Relationship == RelationshipType.Brother_in_law.ToString()) return RelationshipType.Uncle.ToString();
            if (relativeRelativeRel.Relationship == RelationshipType.Cousin.ToString()) return RelationshipType.Cousin.ToString();
            if (relativeRelativeRel.Relationship == RelationshipType.Daughter.ToString()) return RelationshipType.Sister.ToString();
